...
import net.mcreator.levraimod.block.MoonblockBlock;
...
public class MoonDimension extends LeVraiModModElements.ModElement {
	public MoonDimension(LeVraiModModElements instance) {
		super(instance, 68);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(MoonblockBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("le_vrai_mod:moonbio")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("le_vrai_mod:moon"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
