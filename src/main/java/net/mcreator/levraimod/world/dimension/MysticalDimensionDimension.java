...
public class MysticalDimensionDimension extends LeVraiModModElements.ModElement {
	public MysticalDimensionDimension(LeVraiModModElements instance) {
		super(instance, 205);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(MysticalDirtBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("le_vrai_mod:mystical_forest")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("le_vrai_mod:mystical_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
