...
package net.mcreator.levraimod.world.biome;
...
import net.mcreator.levraimod.block.MysticalLogBlock;
import net.mcreator.levraimod.block.MysticalGrassBlock;
import net.mcreator.levraimod.block.MysticalDirtBlock;
...
public class MysticalForestBiome extends LeVraiModModElements.ModElement {
	public static Biome biome;

	public MysticalForestBiome(LeVraiModModElements instance) {
		super(instance, 205);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-3407668).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-3407668).withGrassColor(9470285).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(MysticalGrassBlock.block.getDefaultState(),
								MysticalDirtBlock.block.getDefaultState(), MysticalDirtBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("le_vrai_mod:mystical_forest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("mystical_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mystical_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mystical_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
