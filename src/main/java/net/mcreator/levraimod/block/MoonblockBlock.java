...
public class MoonblockBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:moonblock")
	public static final Block block = null;

	public MoonblockBlock(LeVraiModModElements instance) {
		super(instance, 48);
	}
