...
public class RenewedlogBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:renewedlog")
	public static final Block block = null;

	public RenewedlogBlock(LeVraiModModElements instance) {
		super(instance, 45);
	}
