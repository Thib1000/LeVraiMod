...
public class CobblestonemulticompressedBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:cobblestonemulticompressed")
	public static final Block block = null;

	public CobblestonemulticompressedBlock(LeVraiModModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestonemulticompressed");
		}
