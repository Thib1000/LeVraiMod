...
public class WetdirtBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:wetdirt")
	public static final Block block = null;

	public WetdirtBlock(LeVraiModModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.05f, 0f).setLightLevel(s -> 0)
					.slipperiness(5f));
			setRegistryName("wetdirt");
		}
