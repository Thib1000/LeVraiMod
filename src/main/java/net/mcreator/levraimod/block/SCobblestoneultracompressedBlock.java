...
public class SCobblestoneultracompressedBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:s_cobblestoneultracompressed")
	public static final Block block = null;

	public SCobblestoneultracompressedBlock(LeVraiModModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("s_cobblestoneultracompressed");
		}
