...
public class MysticalLogBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:mystical_log")
	public static final Block block = null;

	public MysticalLogBlock(LeVraiModModElements instance) {
		super(instance, 207);
	}
