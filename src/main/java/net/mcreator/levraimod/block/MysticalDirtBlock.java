...
public class MysticalDirtBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:mystical_dirt")
	public static final Block block = null;

	public MysticalDirtBlock(LeVraiModModElements instance) {
		super(instance, 206);
	}
