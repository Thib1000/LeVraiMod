...
public class GlassaleloreBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:glassalelore")
	public static final Block block = null;

	public GlassaleloreBlock(LeVraiModModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.05f, 10f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("glassalelore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GlassaleloreBlock.block));
		}
	}
}
