...
import net.mcreator.levraimod.procedures.NethergrassLorsDunClicDroitSurLeBlocProcedure;
...
public class MineralgrassBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:mineralgrass")
	public static final Block block = null;

	public MineralgrassBlock(LeVraiModModElements instance) {
		super(instance, 61);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			NethergrassLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
