...
public class StonerenewedBlock extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:stonerenewed")
	public static final Block block = null;

	public StonerenewedBlock(LeVraiModModElements instance) {
		super(instance, 37);
	}
