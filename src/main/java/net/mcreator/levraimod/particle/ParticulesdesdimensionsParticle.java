...
package net.mcreator.levraimod.particle;
...
public class ParticulesdesdimensionsParticle {
	public static final BasicParticleType particle = new BasicParticleType(false);

	@SubscribeEvent
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particulesdesdimensions"));
	}
