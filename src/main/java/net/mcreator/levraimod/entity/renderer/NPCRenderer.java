...
import net.mcreator.levraimod.entity.NPCEntity;
...
public class NPCRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NPCEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsteve(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("le_vrai_mod:textures/stevelevraienfaitnonmaiscenestpasgrave.png");
					}
				};
			});
		}
