...
public class SundustItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:sundust")
	public static final Item block = null;

	public SundustItem(LeVraiModModElements instance) {
		super(instance, 15);
	}
