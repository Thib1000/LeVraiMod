...
public class LingotdesdimensionsItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:lingotdesdimensions")
	public static final Item block = null;

	public LingotdesdimensionsItem(LeVraiModModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lingotdesdimensions");
		}
