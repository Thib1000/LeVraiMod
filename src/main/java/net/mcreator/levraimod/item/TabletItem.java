...
import net.mcreator.levraimod.gui.TesyhGuiWindow;
...
public class TabletItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:tablet")
	public static final Item block = null;

	public TabletItem(LeVraiModModElements instance) {
		super(instance, 53);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof TesyhGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(Thib1000ItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("tablet");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new TesyhGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
