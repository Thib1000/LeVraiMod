...
public class SunnuggetsItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:sunnuggets")
	public static final Item block = null;

	public SunnuggetsItem(LeVraiModModElements instance) {
		super(instance, 23);
	}
