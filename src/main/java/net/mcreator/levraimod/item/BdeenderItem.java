...
public class BdeenderItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:bdeender")
	public static final Item block = null;

	public BdeenderItem(LeVraiModModElements instance) {
		super(instance, 6);
	}
