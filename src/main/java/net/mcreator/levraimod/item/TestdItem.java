...
import net.mcreator.levraimod.entity.renderer.TestdRenderer;
import net.mcreator.levraimod.block.CompressedcobblestoneBlock;
import net.mcreator.levraimod.LeVraiModModElements;

import java.util.Random;

@LeVraiModModElements.ModElement.Tag
public class TestdItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:testd")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_testd").setRegistryName("projectile_testd");

	public TestdItem(LeVraiModModElements instance) {
		super(instance, 55);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TestdRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CompressedcobblestoneBlock.block);
		}
