...
public class StickdesdimensionsItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:stickdesdimensions")
	public static final Item block = null;

	public StickdesdimensionsItem(LeVraiModModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stickdesdimensions");
		}
