...
public class BdenetherItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:bdenether")
	public static final Item block = null;

	public BdenetherItem(LeVraiModModElements instance) {
		super(instance, 5);
	}
