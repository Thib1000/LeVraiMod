...
public class RubymultitoolItem extends LeVraiModModElements.ModElement {
	@ObjectHolder("le_vrai_mod:rubymultitool")
	public static final Item block = null;

	public RubymultitoolItem(LeVraiModModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("rubymultitool"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(Thib1000ItemGroup.tab).maxDamage(5000));
		}
