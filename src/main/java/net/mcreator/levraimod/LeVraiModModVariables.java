package net.mcreator.levraimod;
...
public class LeVraiModModVariables {
	public LeVraiModModVariables(LeVraiModModElements elements) {
		elements.addNetworkMessage(WorldSavedDataSyncMessage.class, WorldSavedDataSyncMessage::buffer, WorldSavedDataSyncMessage::new,
				WorldSavedDataSyncMessage::handler);
	}

	public static boolean poseruneblockdedim = false;
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				LeVraiModMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			...
			if (world instanceof World && !world.isRemote())
				LeVraiModMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(((World) world)::getDimensionKey),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "le_vrai_mod_mapvars";
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (world instanceof World && !world.isRemote())
				LeVraiModMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
