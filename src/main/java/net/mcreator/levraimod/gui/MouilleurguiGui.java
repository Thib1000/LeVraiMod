...
import net.mcreator.levraimod.procedures.MouilleurprocedProcedure;
...
public class MouilleurguiGui extends LeVraiModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MouilleurguiGui(LeVraiModModElements instance) {
		super(instance, 153);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("mouilleurgui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, MouilleurguiGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			MouilleurprocedProcedure.executeProcedure(Stream
