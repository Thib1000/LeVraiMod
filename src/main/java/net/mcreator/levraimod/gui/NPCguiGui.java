...
import net.mcreator.levraimod.procedures.RecuperermespouvoirsNPCProcedure;
import net.mcreator.levraimod.procedures.NPCupgradebuttonProcedure;
...
public class NPCguiGui extends LeVraiModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public NPCguiGui(LeVraiModModElements instance) {
		super(instance, 162);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("np_cgui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, NPCguiGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			NPCupgradebuttonProcedure.executeProcedure(Stream
		...
		if (buttonID == 1) {
			...
			RecuperermespouvoirsNPCProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
