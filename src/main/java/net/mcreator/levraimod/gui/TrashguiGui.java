...
import net.mcreator.levraimod.procedures.TrashprossessProcedure;
...
public class TrashguiGui extends LeVraiModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public TrashguiGui(LeVraiModModElements instance) {
		super(instance, 188);
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			TrashprossessProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
