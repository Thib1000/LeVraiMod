...
import net.mcreator.levraimod.procedures.ForgeguiPendantQueCeGUIEstOuvertParTickProcedure;
...
public class ForgeguiGui extends LeVraiModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public ForgeguiGui(LeVraiModModElements instance) {
		super(instance, 193);
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			ForgeguiPendantQueCeGUIEstOuvertParTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 112, 33) {
				@Override
